...
Rathena::autoCompoundModelv2(DataFrame,TimeColumnName,FeatureName,SplitDataAt,Frequency,ForecastPeriods,Holiday,PlotIt,xlab,ylab,EquiDist,MinLowerBound,MaxUpperBound,...)
